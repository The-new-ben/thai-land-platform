...
tl_test_assert( false !== strpos( $css, 'html.thp-content-document, body.thp-real-estate, .thp-content { overflow: visible; }' ), 'Responsive sticky header remains trapped by a page overflow container.' );
...
tl_test_assert( false !== strpos( $css, '#pojo-a11y-toolbar.pojo-a11y-toolbar-open { left: 76px !important; }' ) && false !== strpos( $css, '#pojo-a11y-toolbar.pojo-a11y-toolbar-open .pojo-a11y-toolbar-toggle { left: 180px !important; }' ), 'Open accessibility panel is not aligned with its responsive header dock.' );
